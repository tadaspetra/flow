/**
 * Pure mouse trail utilities — CJS module for use in main process (render service).
 * Mirrors the ESM version in src/renderer/features/timeline/mouse-trail.js
 */
...
module.exports = { lookupMouseAt, lookupSmoothedMouseAt, subsampleTrail };
